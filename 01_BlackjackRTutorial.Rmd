...
## Basics and objectives of this Part
- understand KNITR & r markdown syntax and document structure
- basic syntax, data structures & functions
- using these functions & data structures to simulate the game
- perform some basic hypothesis testing using the simulator
...
The dotted lines represent the expected (random) frequency of appearance of a card (c) $$ P(c) = \frac{1}{13} = 0.0769 $$. There are clearly a few groups of cards that appear more frequently in busted hands and others that appear more frequently in hands that stand (esp. aces).
...
## Logistic regression of identified clusters

Consider the analogy of busted hands and the cards dealt in a given round to the incidence of disease in the presence or absence of corresponding risk and protective factors. 
...
## Can we define a descriptive index of this vulnerability?


## can we associate remaining cards in the shoe with this vulnerability?
Do remaining cards in the shoe correlate with increased probability of going bust?
...
# Dealer Busts
A notable outcome for any player is the dealer going bust. We can focus on this outcome in particular. 

## When did the dealer go bust?
Since roughly half of the players' wins come from hands where the dealer goes bust (assuming that they did not already go bust), it's reasonable to ask where in the shoe these busts occur to see if there is any obvious pattern (which there isn't). 
...
```{r, fig.align = "center", out.width = "100%"}
    ...
    factors <- c("CARDS_MEAN", "CARDS_SUM", 
                 ...
                 "CARDS_DEALT_UPCARD_SUM", "CARDS_MEAN_VAL_REMAINING_SHOE")
